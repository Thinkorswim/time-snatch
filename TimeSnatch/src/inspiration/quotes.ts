export const quotes = [
    ...
    {
        quote: 'The greatest amount of wasted time is the time not getting started.',
        author: "- Dawson Trotman"
    },
    {
        quote: 'Waiting is a trap. There will always be reasons to wait. The truth is, there are only two things in life, reasons and results, and reasons simply don’t count.',
        author: "- Robert Anthony"
    },
    {
        quote: 'Stop talking. Start walking.',
        author: "- L.M. Heroux"
    },
    {
    ...
    {
        quote: 'Begin while others are procrastinating. Work while others are wishing.',
    ...
    {
        quote: 'The journey is part of the experience — an expression of the seriousness of one\'s intent.',
